...
$id = $_GET['id'];
$data = showDataEditTransaksi($conn, $id);
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-md">
                                <div class="md:col-span-2 flex flex-col gap-xs">
                                    <form action="action.php?aksi=update" method="post" enctype="multipart/form-data">
                                        ...
                                        <label class="font-label-md text-on-surface-variant">User</label>
                                        <select class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" name="id_user" id="">
                                            <?php
                                            $dataUser = showDataUser($conn);

                                            while ($userItem = $dataUser->fetch_assoc()) {
                                                
                                            ?>

                                                <option value="<?= $userItem['id'] ?>"
                                                    <?= ($row['id_user'] == $userItem['id']) ? 'selected' : '' ?>>
                                                    <?= $userItem['nama'] ?>
                                                </option>
                                        ...
                                        <label class="font-label-md text-on-surface-variant">Total Pembelian</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. 150000" type="text" name="total_pembelian" value="<?php echo $row['total_pembelian'] ?>" />
                                        <label class="font-label-md text-on-surface-variant">Tgl_Transaksi</label>
                                        <input class="w-full p-md border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-primary-container focus:outline-none" placeholder="e.g. 2023-10-10" type="date" name="tgl_transaksi" value="<?php echo $row['tgl_transaksi'] ?>" />
