...
<aside class="hidden md:flex flex-col p-4 space-y-2 h-screen w-64 border-r border-red-700 bg-red-600">
    ...
    <div class="flex flex-col items-center justify-center py-6 mb-2">
        <img src="/WARUNGKU/layoutCustomer/iyo.png" alt="Mie Kobong logo" class="w-16 h-16 object-contain rounded-2xl shadow-md bg-white p-1" />
        <h1 class="text-base font-black text-white leading-tight mt-2">Mie <a class="text-yellow-300 hover:text-yellow-400">Kobong</a></h1>
        <p class="text-[10px] uppercase tracking-widest text-white font-bold">Admin Terminal</p>
    </div>

    <!-- Divider -->
    <div class="border-t border-red-500 mb-2"></div>
