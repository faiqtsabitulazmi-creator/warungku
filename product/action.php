...
{
    $query = "select
 product.id, product.nama, product.harga, product.image, 
product.stock, category.nama as nama_category from product join category on product.id_category = category.id;";
...
{
    $query = "insert into product (nama, harga, deskripsi, image, stock, id_category) values ('$nama', '$harga', '$deskripsi', '$image', '$stock', '$category')";
    $result = $con->execute_query($query);
...
function updateProduct($con, $id, $nama, $harga, $deskripsi, $image, $stock, $category)
{
    $query = '';
    if ($image == '') {
        $query = "update product set nama = '$nama', harga = '$harga', deskripsi = '$deskripsi', stock = '$stock', id_category = '$category' where id = $id";
    } else {
        $query = "update product set nama = '$nama', harga = '$harga', deskripsi = '$deskripsi', stock = '$stock', image = '$image', id_category = '$category' where id = $id";
    }
