        ...
        <div class="flex-1 overflow-y-auto p-6 bg-surface-container-lowest">
            <div class="max-w-xl mx-auto">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h1 class="text-headline-md font-headline-md text-on-surface">Edit Role</h1>
                        <p class="text-body-sm text-slate-500 mt-1">Update the name of this role.</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <form method="POST" action="action.php?aksi=update" class="p-6 space-y-5">
                        ...
                        <div class="flex flex-col space-y-1.5">
                            ...
                            <p class="text-label-md text-slate-400">Change the name for this role.</p>
                        </div>
